...
if ( ! function_exists( 'gracey_core_add_centered_header_options' ) ) {
	/**
	 ...
	 */
	function gracey_core_add_centered_header_options( $page, $general_header_tab ) {
	...
	add_action( 'gracey_core_action_after_header_options_map', 'gracey_core_add_centered_header_options', 10, 2 );
}
