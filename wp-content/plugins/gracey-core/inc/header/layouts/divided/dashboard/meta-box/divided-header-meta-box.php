...
if ( ! function_exists( 'gracey_core_add_divided_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function gracey_core_add_divided_header_meta( $page ) {
	...
	add_action( 'gracey_core_action_after_page_header_meta_map', 'gracey_core_add_divided_header_meta' );
}
