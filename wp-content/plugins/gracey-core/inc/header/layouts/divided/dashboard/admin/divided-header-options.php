...
if ( ! function_exists( 'gracey_core_add_divided_header_options' ) ) {
	/**
	 ...
	 */
	function gracey_core_add_divided_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'       => 'qodef_divided_header_section',
				'title'      => esc_html__( 'Divided Header', 'gracey-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'gracey_core_action_after_header_options_map', 'gracey_core_add_divided_header_options', 10, 2 );
}
