...
if ( ! class_exists( 'GraceyCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class GraceyCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'gracey_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return GraceyCore_Dashboard_Rest_API
		 */
	...
	GraceyCore_Dashboard_Rest_API::get_instance();
}
