...
do_action( 'gracey_core_action_before_team_content_holder' );
?>
	<main id="qodef-page-content" class="qodef-grid qodef-layout--template <?php echo esc_attr( gracey_core_get_grid_gutter_classes() ); ?>">
		<div class="qodef-grid-inner clear">
			...
			gracey_core_template_part( 'post-types/team', 'templates/team', $content );
...
do_action( 'gracey_core_action_after_team_content_holder' );
?>
