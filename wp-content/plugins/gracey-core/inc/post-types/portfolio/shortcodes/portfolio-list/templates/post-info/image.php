		...
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php if ( $distort_animation ) {?>
				<span class='qodef--item-filter-holder'>
					<?php echo gracey_core_get_list_shortcode_item_image( $image_dimension, $portfolio_list_image, $custom_image_width, $custom_image_height ); ?>
				</span>
			<?php } else { ?>
				<?php echo gracey_core_get_list_shortcode_item_image( $image_dimension, $portfolio_list_image, $custom_image_width, $custom_image_height ); ?>
			<?php } ?>
...
<?php } else { ?>
	<div class="qodef-e-media-image">
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php if ( $distort_animation ) {?>
				<span class='qodef--item-filter-holder'></span>
			<?php } ?>
		</a>
	</div>
<?php } ?>
