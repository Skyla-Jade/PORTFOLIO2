<?php
if( $intro_item === 'yes' ) {
    gracey_core_list_sc_template_part( 'post-types/portfolio/shortcodes/portfolio-list', 'post-info/intro-item', '', $params );
}
?>
...
<?php if ( $query_result->have_posts() ) {
	while ( $query_result->have_posts() ) :
		...
		gracey_core_list_sc_template_part( 'post-types/portfolio/shortcodes/portfolio-list', 'layouts/' . $layout, '', $params );
