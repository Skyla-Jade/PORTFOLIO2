...
if ( ! function_exists( 'gracey_core_add_portfolio_info_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function gracey_core_add_portfolio_info_typography_options( $page ) {
		...
		if ( $page ) {
			$portfolio_info_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Portfolio Info', 'gracey-core' ),
					'description' => esc_html__( 'Set typography values for portfolio info elements', 'gracey-core' ),
				)
			);
			...
			$portfolio_info_typography_row = $portfolio_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Info Styles', 'gracey-core' ),
				)
			);
			...
			$portfolio_info_link_typography_row = $portfolio_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Info Link Styles', 'gracey-core' ),
				)
			);
	...
	add_action( 'gracey_core_action_after_portfolio_options_map', 'gracey_core_add_portfolio_info_typography_options' );
}
