...
if ( ! function_exists( 'gracey_core_add_portfolio_archive_list_options' ) ) {
	/**
	 * Function that add list options for portfolio archive module
	 */
	function gracey_core_add_portfolio_archive_list_options( $tab ) {
		$list_item_layouts = apply_filters( 'gracey_core_filter_portfolio_list_layouts', array() );
		...
		if ( $tab ) {
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose layout for list item on archive lists', 'gracey-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose an appearance style for archive lists', 'gracey-core' ),
			...
			$tab->add_field_element(
				array(
					'field_type'  => 'select',
					'name'        => 'qodef_portfolio_distort_animation',
					'title'       => esc_html__( 'Enable Distort Animation on Hover', 'gracey-core' ),
					'description' => esc_html__( 'Enable distort animation on hover for archive lists', 'gracey-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Masonry Image Proportions', 'gracey-core' ),
					'description' => esc_html__( 'Choose image proportions for archive lists', 'gracey-core' ),
					'options'     => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose number of columns for archive lists', 'gracey-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose space between items for archive lists', 'gracey-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 1367 and 1440 px for archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 1025 and 1366 px for archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 769 and 1024 px for archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 681 and 768 px for archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 481 and 680 px for archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 0 and 480 px for archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enable loop for slider display of archive lists', 'gracey-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enable autoplay for slider display of archive lists', 'gracey-core' ),
					'options'     => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'  => array(
						'show' => array(
							'qodef_portfolio_archive_behavior' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enter slider speed for slider display of archive lists', 'gracey-core' ),
					'dependency'  => array(
						'show' => array(
							'qodef_portfolio_archive_behavior' => array(
								'values'        => 'slider',
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Enable navigation for slider display of archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Enable pagination for slider display of archive lists', 'gracey-core' ),
					'default_value' => '3',
					'options'       => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose pagination type for archive lists', 'gracey-core' ),
	...
	add_action( 'gracey_core_action_after_portfolio_options_archive', 'gracey_core_add_portfolio_archive_list_options' );
}
