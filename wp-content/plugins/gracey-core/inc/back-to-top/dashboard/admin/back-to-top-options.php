...
if ( ! function_exists( 'gracey_core_add_back_to_top_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function gracey_core_add_back_to_top_options( $page ) {
		...
		if ( $page ) {
			...
			$page->add_field_element(
				array(
					'field_type'    => 'yesno',
					'name'          => 'qodef_back_to_top_stamp',
					'title'         => esc_html__( 'Enable Back to Top Stamp Icon', 'gracey-core' ),
					'default_value' => 'yes',
				)
			);
			...
			$page->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Back to Top Icon SVG Path', 'gracey-core' ),
					'description' => esc_html__( 'Enter your back to top icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'gracey-core' ),
					'dependency'  => array(
						'show' => array(
			...
			$back_to_top_section = $page->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Back to Top Styles', 'gracey-core' ),
					'dependency' => array(
						'show' => array(
							'qodef_back_to_top' => array(
								'values'        => 'yes',
			...
			$back_to_top_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_back_to_top_icon_holder_size',
					'title'      => esc_html__( 'Icon Holder Size', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
						'suffix'    => 'px',
					),
	...
	add_action( 'gracey_core_action_after_general_options_map', 'gracey_core_add_back_to_top_options', 15 );
}
