...
if ( ! function_exists( 'gracey_core_fullscreen_menu_options' ) ) {
	/**
	 * Function that add global options for current module
	 */
	function gracey_core_fullscreen_menu_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Fullscreen Menu', 'gracey-core' ),
				'description' => esc_html__( 'Global Fullscreen Menu Options', 'gracey-core' ),
			)
		);
		...
		if ( $page ) {
			$page->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Fullscreen Menu in Grid', 'gracey-core' ),
					'default_value' => 'yes',
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Fullscreen Menu Open Icon SVG Path', 'gracey-core' ),
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Fullscreen Menu Close Icon SVG Path', 'gracey-core' ),
			...
			do_action( 'gracey_core_action_after_fullscreen_menu_options_map', $page );
		}
	}

	add_action( 'gracey_core_action_default_options_init', 'gracey_core_fullscreen_menu_options', gracey_core_get_admin_options_map_position( 'fullscreen-menu' ) );
}
