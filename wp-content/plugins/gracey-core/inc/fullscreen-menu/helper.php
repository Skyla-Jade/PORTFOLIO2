...
if ( ! function_exists( 'gracey_core_register_fullscreen_menu' ) ) {
	/**
	 ...
	 * @return array
	 */
	function gracey_core_register_fullscreen_menu( $menus ) {
		$menus['fullscreen-menu-navigation'] = esc_html__( 'Fullscreen Navigation', 'gracey-core' );

		return $menus;
	}

	add_filter( 'gracey_filter_register_navigation_menus', 'gracey_core_register_fullscreen_menu' );
}

if ( ! function_exists( 'gracey_core_set_fullscreen_menu_typography_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function gracey_core_set_fullscreen_menu_typography_styles( $style ) {
		$scope = GRACEY_CORE_OPTIONS_NAME;

		$first_lvl_styles        = gracey_core_get_typography_styles( $scope, 'qodef_fullscreen_1st_lvl' );
		$first_lvl_hover_styles  = gracey_core_get_typography_hover_styles( $scope, 'qodef_fullscreen_1st_lvl' );
		$second_lvl_styles       = gracey_core_get_typography_styles( $scope, 'qodef_fullscreen_2nd_lvl' );
		$second_lvl_hover_styles = gracey_core_get_typography_hover_styles( $scope, 'qodef_fullscreen_2nd_lvl' );
		...
		$first_lvl_active_color = gracey_core_get_option_value( 'admin', 'qodef_fullscreen_1st_lvl_active_color' );
		...
		$second_lvl_active_color = gracey_core_get_option_value( 'admin', 'qodef_fullscreen_2nd_lvl_active_color' );
	...
	add_filter( 'gracey_filter_add_inline_style', 'gracey_core_set_fullscreen_menu_typography_styles' );
}
