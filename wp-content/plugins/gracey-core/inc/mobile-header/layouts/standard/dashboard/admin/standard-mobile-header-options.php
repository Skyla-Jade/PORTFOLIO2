...
if ( ! function_exists( 'gracey_core_add_standard_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function gracey_core_add_standard_mobile_header_options( $page, $general_tab ) {

		$section = $general_tab->add_section_element(
			array(
				'name'       => 'qodef_standard_mobile_header_section',
				'title'      => esc_html__( 'Standard Mobile Header', 'gracey-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'gracey_core_action_after_mobile_header_options_map', 'gracey_core_add_standard_mobile_header_options', 10, 2 );
}
