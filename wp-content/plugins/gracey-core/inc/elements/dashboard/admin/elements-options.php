...
if ( ! function_exists( 'gracey_core_add_elements_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function gracey_core_add_elements_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'elements',
				'icon'        => 'fa fa-book',
				'title'       => esc_html__( 'Elements', 'gracey-core' ),
				'description' => esc_html__( 'Global Elements Options', 'gracey-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$label_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Label Styles', 'gracey-core' ),
				)
			);
			...
			$input_fields_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Input Fields Styles', 'gracey-core' ),
				)
			);
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Focus Color', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Background Focus Color', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Focus Color', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Width', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Radius', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Style', 'gracey-core' ),
			...
			$button_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Styles', 'gracey-core' ),
				)
			);
			...
			$button_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Box Shadow', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_simple_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Textual Styles', 'gracey-core' ),
				)
			);
			...
			$slider_arrow_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Slider Arrow Styles', 'gracey-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Left Icon SVG Path', 'gracey-core' ),
					'description' => esc_html__( 'Enter your sliders arrow left icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'gracey-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Right Icon SVG Path', 'gracey-core' ),
					'description' => esc_html__( 'Enter your sliders arrow right icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'gracey-core' ),
				)
			);
			...
			$slider_arrow_row = $slider_arrow_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Icon Styles', 'gracey-core' ),
				)
			);
			...
			$slider_arrow_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Icon Size', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
						'suffix'    => 'px',
					),
			...
			do_action( 'gracey_core_action_after_elements_options_map', $page );
		}
	}

	add_action( 'gracey_core_action_default_options_init', 'gracey_core_add_elements_options' );
}
