...
if ( ! function_exists( 'gracey_core_nav_menu_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function gracey_core_nav_menu_options( $page ) {
		...
		if ( $page ) {
			$main_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Main Menu Settings', 'gracey-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Dropdown Background Color', 'gracey-core' ),
					'description' => esc_html__( 'Set header menu dropdown color', 'gracey-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Full Width', 'gracey-core' ),
					'default_value' => 'yes',
				)
			);
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Wide Dropdown Background Color', 'gracey-core' ),
					'args'       => array(
						'col_width' => 4,
					),
				)
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Content In Grid', 'gracey-core' ),
					'default_value' => 'yes',
					'args'          => array(
						'col_width' => 4,
					),
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Main Menu Dropdown Appearance', 'gracey-core' ),
					'default_value' => 'default',
					'options'       => array(
						'default'        => esc_html__( 'Default', 'gracey-core' ),
						'animate-height' => esc_html__( 'Animate Height', 'gracey-core' ),
					),
					'args'          => array(
						'col_width' => 4,
					),
			...
			$nav_menu_typography_section = $main_menu_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Main Menu Typography', 'gracey-core' ),
				)
			);
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Hover/Active Text Decoration', 'gracey-core' ),
					'options'    => gracey_core_get_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 3,
					),
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Left/Right', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Padding Left/Right', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$second_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Second Level Wide Typography', 'gracey-core' ),
				)
			);
			...
			$third_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Third Level Wide Typography', 'gracey-core' ),
				)
			);
	...
	add_action( 'gracey_core_action_after_header_options_map', 'gracey_core_nav_menu_options' );
}
