...
if ( ! class_exists( 'GraceyCore_Shortcodes' ) ) {
	class GraceyCore_Shortcodes {
		...
		function init() {
			...
			include_once GRACEY_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once GRACEY_CORE_SHORTCODES_PATH . '/class-graceycore-shortcode.php';
			include_once GRACEY_CORE_SHORTCODES_PATH . '/class-graceycore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'gracey_core_filter_register_shortcodes', $shortcodes = array() );
	...
	GraceyCore_Shortcodes::get_instance();
}
