...
if ( ! function_exists( 'gracey_core_add_section_title_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function gracey_core_add_section_title_shortcode( $shortcodes ) {
		$shortcodes[] = 'GraceyCore_Section_Title_Shortcode';

		return $shortcodes;
	}

	add_filter( 'gracey_core_filter_register_shortcodes', 'gracey_core_add_section_title_shortcode' );
}

if ( class_exists( 'GraceyCore_Shortcode' ) ) {
	class GraceyCore_Section_Title_Shortcode extends GraceyCore_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( GRACEY_CORE_SHORTCODES_URL_PATH . '/section-title' );
			$this->set_base( 'gracey_core_section_title' );
			$this->set_name( esc_html__( 'Section Title', 'gracey-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds section title element', 'gracey-core' ) );
			...
			$this->set_option(
				array(
					...
					'group'       => esc_html__( 'Title Style', 'gracey-core' ),
				)
			);
			$this->set_option(
				array(
			...
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'link',
					'title'      => esc_html__( 'Title Custom Link', 'gracey-core' ),
					'group'      => esc_html__( 'Title Style', 'gracey-core' ),
				)
			);
			$this->set_option(
			...
			$this->set_option(
				array(
					...
					'group'      => esc_html__( 'Text Style', 'gracey-core' ),
				)
			);
			$this->set_option(
				array(
		...
		public function render( $options, $content = null ) {
			...
			return gracey_core_get_template_part( 'shortcodes/section-title', 'templates/section-title', '', $atts );
		}
