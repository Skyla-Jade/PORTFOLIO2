...
if ( ! function_exists( 'gracey_core_get_contact_form_7_forms' ) ) {
	/**
	 ...
	 * @return array
	 */
	function gracey_core_get_contact_form_7_forms() {
		$options       = array();
		...
		if ( ! empty( $contact_forms ) ) {
			...
			$options[0] = esc_html__( 'No contact forms found', 'gracey-core' );
		}
