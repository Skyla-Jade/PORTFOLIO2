...
if ( ! function_exists( 'gracey_coreadd_product_info_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function gracey_coreadd_product_info_typography_options( $page ) {
		...
		if ( $page ) {
			$product_info_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Product Info', 'gracey-core' ),
					'description' => esc_html__( 'Set typography values for product info elements', 'gracey-core' ),
				)
			);
			...
			$price_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Price Typography', 'gracey-core' ),
				)
			);
			...
			$product_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Price Styles', 'gracey-core' ),
				)
			);
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Discount Color', 'gracey-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => gracey_coreget_select_type_options_pool( 'font_weight' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => gracey_coreget_select_type_options_pool( 'text_transform' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => gracey_coreget_select_type_options_pool( 'font_style' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => gracey_coreget_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_single_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Single Price Styles', 'gracey-core' ),
				)
			);
			...
			$product_info_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Product Info Typography', 'gracey-core' ),
				)
			);
			...
			$product_label_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Label Styles', 'gracey-core' ),
				)
			);
			...
			$product_info_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Styles', 'gracey-core' ),
				)
			);
			...
			$product_info_link_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Link Styles', 'gracey-core' ),
				)
			);
	...
	add_action( 'gracey_coreaction_after_woo_options_map', 'gracey_coreadd_product_info_typography_options' );
}
