			...
			<div class="qodef-woo-dropdown-item qodef-e">
				...
				<div class="qodef-e-content">
                    ...
                    <p class="qodef-e-price">
                        <span class="qodef-e-quantity"><?php echo sprintf( esc_html__( '%s x ', 'gracey-core' ), esc_attr( $cart_item['quantity'] ) ); ?></span>
                        <?php echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ); ?>
                    </p>
                    <?php echo sprintf( '<a href="%s" class="qodef-e-remove remove" title="%s">%s</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_attr__( 'Remove this item', 'gracey-core' ), qode_framework_icons()->get_specific_icon_from_pack( 'close', 'ionicons' ) ); ?>
				</div>
			</div>
			<?php
		}
