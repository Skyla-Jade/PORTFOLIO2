...
if ( ! class_exists( 'GraceyCore_WooCommerce_YITH_Wishlist' ) ) {
	class GraceyCore_WooCommerce_YITH_Wishlist {
		...
		/**
		 * @return GraceyCore_WooCommerce_YITH_Wishlist
		 */
		...
		function change_templates_position() {
			...
			add_action( 'gracey_action_product_list_item_additional_image_content', 'gracey_core_get_yith_wishlist_shortcode' );
			add_action( 'gracey_core_action_product_list_item_additional_image_content', 'gracey_core_get_yith_wishlist_shortcode' );
		}
	...
	GraceyCore_WooCommerce_YITH_Wishlist::get_instance();
}
