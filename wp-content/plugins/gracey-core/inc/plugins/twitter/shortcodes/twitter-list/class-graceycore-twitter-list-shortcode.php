...
if ( ! function_exists( 'gracey_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function gracey_core_add_twitter_list_shortcode( $shortcodes ) {
		if ( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'GraceyCore_Twitter_List_Shortcode';
		}

		return $shortcodes;
	}

	add_filter( 'gracey_core_filter_register_shortcodes', 'gracey_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'GraceyCore_List_Shortcode' ) ) {
	class GraceyCore_Twitter_List_Shortcode extends GraceyCore_List_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( GRACEY_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'gracey_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'gracey-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'gracey-core' ) );
			...
			$this->set_option(
				array(
					...
					'field_type' => 'text',
					'title'      => esc_html__( 'Number of Tweets', 'gracey-core' ),
					'group'      => esc_html__( 'Info', 'gracey-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Retweeted Text', 'gracey-core' ),
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Avatar Image', 'gracey-core' ),
					'options'       => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'gracey-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Author Name', 'gracey-core' ),
					'options'       => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'gracey-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Text', 'gracey-core' ),
					'options'       => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'gracey-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Media Placeholder', 'gracey-core' ),
			...
			$this->set_option(
				array(
					'name'          => 'show_date',
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Date', 'gracey-core' ),
					'options'       => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'gracey-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Actions', 'gracey-core' ),
					'options'       => gracey_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'gracey-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Twitter Link', 'gracey-core' ),
					'options'       => gracey_core_get_select_type_options_pool( 'no_yes' ),
					'default_value' => 'no',
					'group'         => esc_html__( 'Info', 'gracey-core' ),
				)
		...
		public function render( $options, $content = null ) {
			...
			return gracey_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
