...
if ( ! function_exists( 'gracey_core_add_simple_line_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function gracey_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'GraceyCore_Simple_Line_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'gracey_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class GraceyCore_Simple_Line_Icons_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return GRACEY_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}
