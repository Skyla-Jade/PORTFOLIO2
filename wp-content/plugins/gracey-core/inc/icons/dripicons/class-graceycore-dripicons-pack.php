...
if ( ! function_exists( 'gracey_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function gracey_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'GraceyCore_Dripicons_Icon_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'gracey_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class GraceyCore_Dripicons_Icon_Pack extends QodeFrameworkIconPack {
