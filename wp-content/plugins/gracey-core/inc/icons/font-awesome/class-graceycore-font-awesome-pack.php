...
if ( ! function_exists( 'gracey_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function gracey_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'GraceyCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'gracey_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class GraceyCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return GRACEY_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			...
			if ( file_exists( GRACEY_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( GRACEY_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
